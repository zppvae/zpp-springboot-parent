...
import org.zpp.springboot.redis.annotation.SingleUserCache;
...
public class UserService {
     ...
     */
    @SingleUserCache
    public Optional<User> detail(Integer userId) {
    ...
    public Optional<User> update(Integer userId, String name) {
        // 查询用户详情
